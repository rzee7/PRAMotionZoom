...
namespace PRAMotionZoom
{
	...
	public sealed class PRAZoomView : UIScrollView
	{
		...
		public PRAZoomView (CGRect rect, UIImage imageToZoom):base(rect)
		{
			...
			PinchGestureRecognizer.AddTarget (this, new ObjCRuntime.Selector ("pinchGestureRecognized"));
		...
		{
			ContentOffset = new CGPoint ((ContentSize.Width / 2) - (Bounds.Width / 2), (ContentSize.Height / 2) - (Bounds.Height / 2));
		...
		//new
		internal CGPoint clampedContentOffsetForHorizontalOffset(float horizontalOffset) {
			...
			return new CGPoint (clampedXOffset, centeredY);
		}
